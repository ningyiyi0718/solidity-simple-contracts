...
contract MyToken is ERC20Pausable {
    ...
    modifier onlyOperator(){
        require(_operators[msg.sender],"not allowed");
        _;
    }
    modifier onlyPauser(){
    ...
    function deleteOperator(address _operator) public onlyOperator{
        if (_operators[_operator]) {
            delete _operators[_operator];
        }
    }

    function changeUser(address new_pauser) public onlyOperator{
        _pauser=new_pauser;
    }
